...
permalink: /our-story/our-60th-anniversary/concert-for-hope/
variant: markdown
description: ""
...
<div class="yck-component">
    <div class="regular-flow">
        <article id="hopeconcert">
            <section>
                <h2 class="dropcap-title">Concert for Hope - Full Performance</h2>
                <div class="video-container">
                    <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" frameborder="0" title="YouTube video player" src="https://www.youtube-nocookie.com/embed/BGl_8obAgrc?si=jsvgi7cRJrsc097M" height="315" width="560"></iframe>
                </div>
            </section>
        </article>
        <hr>
        <article>
            <section>
                <h2 class="dropcap-title">Concert for Hope - 60th Anniversary</h2><br><br>
                <ul>
                    <li>Date: 21 November 2025, Friday</li>
                    <li>Time: 3 PM to 5 PM</li>
                    <li>Venue: The Performing Art Theatre@YCKSS</li>
                </ul>
                <p>Please scan the QRCode at the bottom-left corner of the "Concert for Hope" poster below to register your interest.</p>
                <figure>
