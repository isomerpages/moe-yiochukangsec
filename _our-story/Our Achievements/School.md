        ...
        <article id="top">
            <section>
                <details name="achievements">
                    <summary id="achieve2025">Achievements 2025
                    </summary>
                    ...
                    <table class="yck-table">
                        <thead>
                            <tr>
                                <th class="yck-th">2025 National Day Awards</th>
                                <th class="yck-th"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>Public Administration Medal (Bronze)</strong></td>
                                <td class="yck-td">Mr Kevin Lim</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Commendation Medal</strong></td>
                                <td class="yck-td">Mdm Ng Hui Yin<br>Mdm Ng Wan Hwee Doreen</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Commendation Award (Military)</strong></td>
                                <td class="yck-td">SLTC (NS) Matthew Yap Choon Pian (SAC Vice-Chairperson)</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Long Service Award</strong></td>
                                <td class="yck-td">Mr David Goh</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="yck-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>Outstanding Science Teacher Award 2025</strong></td>
                    ...
                    <table class="yck-table">
                        <thead>
                            <tr>
                                <th class="yck-th">飞跃教师奖 LEAP Award 2025</th>
                                <th class="yck-th"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>Certificate of Commendation</strong></td>
                                <td class="yck-td">Mdm Chong Lai Khar<br>Mdm Ng Wan Hwee Doreen</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="yck-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>NPCC</strong></td>
                                <td class="yck-td">Unit Overall Proficiency Award: Distinction (Year 2024)<br><br>Singapore Police Force-National Police Cadet Corps (SPF-NPCC) Badge Awardees</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="yck-table">
                        <thead>
                            <tr>
                                <th class="yck-th">Languages</th>
                                <th class="yck-th"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>Chinese Language (MTL)</strong></td>
                                <td class="yck-td">National “Xin” Character Design Competition<br>Achievement: 1 Silver<br><br>National Text Recital Competition 2025<br>Achievement: Distinguished Performance Award<br>Guo Xinlu, Lucy 1F</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Malay Language (MTL)</strong></td>
                                <td class="yck-td">National Choral Recitation Competition<br>Achievement: 4th Position<br><br>National Zonal Malay Scrabble Competition<br>Achievement: 3rd place<br><br>Short Stories Competition ‘Orang Singapura 2025’ -<br>Achievement: Top 5<br>Alysha Izwynda Binte Muhammad Amin</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>English Language</strong></td>
                                <td class="yck-td">Gardens Expressions: Thoughts in Bloom Competition (S1 Cluster)<br>Achievement: First Place<br>Mallawa Arachige Shenuki Dinethya Sec 1</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="yck-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>S1 Cluster Design Innovation Challenge</strong></td>
                                <td class="yck-td"><strong>Top 6 Finalists</strong><br>CLARICE HOR KA YEE (2E)<br>SHERMAINE HUANG SIMIN (2E)<br>SIM JIA XUAN (2E)<br>LEE JIA HUI SOPHIE (2F)</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="yck-table">
                        <thead>
                            <tr>
                                <th class="yck-th">Mathematics</th>
                                <th class="yck-th"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>Singapore &amp; Asian Schools Mathematics Olympiad (SASMO)</strong></td>
                                <td class="yck-td">2 Silver, 7 Bronze, 2 Honourable Mention</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Singapore Mathematic Kangaroo Contest (SMKC)</strong></td>
                                <td class="yck-td">1 Honourable Mention, 12 Bronze, 2 Silver &amp; 1 Gold.</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Singapore Mathematical Olympiad (SMO)</strong></td>
                                <td class="yck-td">3 Honourable Mention</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>National Institute of Education Mathematics Challenge 2025 (NIEMC 2025)</strong></td>
                                <td class="yck-td">3 Higher Distinction, 3 Distinction &amp; 15 Credit</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="yck-table">
                        <thead>
                            <tr>
                                <th class="yck-th">SCIENCE</th>
                                <th class="yck-th"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="yck-td"><strong>26th International Elementz Fair</strong></td>
                                <td class="yck-td">1 Gold award 1 Commendation</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Singapore Junior Physics Olympiad</strong></td>
                                <td>1 Bronze</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>C.B. Paul Science Quiz 2025</strong></td>
                                <td class="yck-td">1 Silver 2 Bronze 1 Merit 1 Honorable mention</td>
                            </tr>
                            <tr>
                                <td class="yck-td"><strong>Singapore Junior Chemistry Olympiad</strong></td>
                                <td class="yck-td">1 Bronze</td>
                            </tr>
                        </tbody>
                    </table>
