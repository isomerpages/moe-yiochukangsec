...
<ul class="jekyllcodex_accordion">
    <li> <input type="checkbox" id="ndp"> <label for="ndp">
        ...
        <img style="width:100%;height:50%" alt="Group photo of students and teachers participating in NDP 2023 seated in a ballroom" src="/images/Our%20Experience/In%20Our%20Community/NDP/yckss_at_ndp_2023_02.jpeg">
    ...
    <li> <input type="checkbox" id="community"> <label for="community">
    ...
    <li><input type="checkbox" id="cluster"> <label for="cluster">
