...
<ul class="jekyllcodex_accordion">
    <li> <input type="checkbox" id="accordion1"> <label for="accordion1">
            <h3>National Day Parade 2023</h3>
        </label>
        <div style="padding: 0.75em;  line-height: 1.25em; text-align: center; font-size: 1em; font-weight: 400;"><iframe style="aspect-ratio: 1.76991 / 1; width: 100%; height: 100%;" allow="fullscreen" allowfullscreen="" src="https://www.youtube.com/embed/HR4seEKIgT4" title="YCKSS National Day Parade (NDP 2023) Act 4 – Onward as One"></iframe>
            <a target="_blank" title="If you don't see the embedded video above, click on the link to watch it on Youtube." href="https://youtu.be/HR4seEKIgT4"><em>National Day Parade (NDP 2023) Act 4 – Onward as One</em></a></div>
