        ...
        <article>
            ...
            <section id="training-schedule">
                ...
                <table class="rwd-table">
                    <thead>
                        <tr>
                            <th>
                                <span class="yck-h5">DAY &amp; TIME:</span>
                            </th>
                            <th>
                                <span class="yck-h5">TEACHERS-IN-CHARGE</span>
                            </th>
                            <th>
                                <span class="yck-h5">VENUE:</span>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td data-th="DAY &amp; TIME:">
                                Every Tuesday<br>3.00pm to 5.30pm
                            </td>
                            <td data-th="TEACHERS-IN-CHARGE">
                                <ul class="nolist-style">
                                    <li>Mr Pang Ronnie</li>
                                    <li>Mdm Nurul</li>
                                    <li>Mr OCtave</li>
                                    <li>Mdm Cindy Ong</li>
                                    <li>MS Chia Yi Ying</li>
                                </ul>
                            </td>
                            <td data-th="VENUE:">
                                <p>
            ...
            <section id="gallery">
                <details>
                    ...
                    <div class="content">
                        <div style="--width: 480px;  --height: 320px;  --quantity: 4; --duration: 30s;" class="carousel glider">
                    ...
                    <div class="deadctr-container">
                        <div class="tooltip">Follow us on IG to find out more!
                            <div class="tooltip__content center-text">
                                <a style="font-weight: 800; font-size: var(--yck-step-1);" class="text-link" rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/ycknpcc">&nbsp; @ycknpcc&nbsp;</a>
                            </div>
                        </div>
                    </div>
                </details>
