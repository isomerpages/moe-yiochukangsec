    ...
    <div class="regular-flow">
        <article>
                        ...
                        <tr>
                            ...
                            <td class="yck-td">
                                <ul class="nolist-style">
                                    <li>Ms Gauwri (ext 144)</li>
                                    <li>Mrs Ilango (ext 175)</li>
                                    <li>Mdm Rathidevi (ext 170)</li>
                                </ul>
                            </td>
                            <td class="yck-td">
                                <p>Dance Studio 1 (Level 3)<br>Blk B3-01</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
            </section>
            <section id="instructorbio">
                <div class="deadctr-container">
                    <div class="card01">
                        <div class="card01-content">
                            <p class="card01-title">Dance Instructor</p>
                            <p class="card01-para">
                                Mdm Suganthi Kesavan <a class="tgext-link" target="_blank" href="https://bharathaaarts.wixsite.com/bharathaaarts/the-founders">(Bharathaa Arts)</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="achievements">
                ...
                <table class="yck-table">
                    <tbody>
                        ...
                        <tr>
                            <td class="yck-td">
                                <p>Deepavali Celebrations at Singapore Police Force's Police Intelligence Department</p>
                                <p>National Day Parade Performance</p>
                            </td>
                        </tr>
                        <tr>
                        </tr><tr>
                        ...
                        <tr>
                            <td class="yck-td">Singapore Youth Festival Arts Presentation<br> - Certificate of Distinction</td>
                        </tr>
                        <tr>
                            <th class="yck-th">
                                <h5>2019</h5>
                        ...
                        <tr>
                            <td class="yck-td">
                                <p>Singapore Youth Festival at Esplanade</p>
                                <p>National Day Observance Ceremony</p>
                                <p>YCK Community Celebration</p>
                            </td>
                        </tr>
                        <tr>
                        </tr><tr>
                        ...
                        <tr>
                            <td class="yck-td">Singapore Youth Festival Central Judging<br> - Gold Award for SYF</td>
                        </tr>
                        <tr>
                            <th class="yck-th">
                                <h5>2009</h5>
                        ...
                        <tr>
                            <td class="yck-td">Singapore Youth Festival Central Judging<br> - Gold with Honours for SYF</td>
                        </tr>
                        <tr>
                            <th class="yck-th">
                                <h5>2008</h5>
            ...
            <section id="more-photos">
                <div style="--width: 800px;  --height: 326px;  --quantity: 3; --duration: 36s;" class="carousel slider">
