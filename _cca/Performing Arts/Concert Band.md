        ...
        <article>
            <section id="top">
                <div class="ken-burns-container">
                    <figure>
                        <img alt="Concert Band performing" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Non%20Academic%20Programmes/CoCurricular%20Activities/Performing%20Arts/Band.jpg" class="kenburns-scale">
                    </figure>
                </div>
            </section>
            <section id="intro">
                        ...
                        <tr>
                            ...
                            <td class="yck-td">
                                <ul class="nolist-style">
                                    <li>Mr Michael Cartwright (ext 128)</li>
                                    <li>Ms Lim Li May (ext 171)</li>
                                    <li>Ms Nur Rafizah Bte Safiee (ext 286)</li>
                                    <li>Ms Fong Ya Yi (Adele) (ext 122)</li>
                                    <li>Mdm Ann Chiam Choon Kwee (ext 144)</li>
                                </ul>
                            </td>
                            <td class="yck-td">
            ...
            <section id="achievements">
                ...
                <div class="info-container">
                    <div class="infocard">
                        ...
                        <ul>
                            <li><b>2021</b><br>Singapore Youth Festival Presentation - <em>Certificate of Accomplishment</em></li>
                            <li><b>2019</b><br>Singapore Youth Festival Arts Presentation - <em>Certificate of Accomplishment</em></li>
                            <li><b>2017</b><br>Exchange concert with Sembawang Wind Orchestra <i>(SWO)</i> @ Singapore Botanic Gardens<br>Singapore Youth Festival Arts Presentation - <em>Certificate of Accomplishment</em></li>
                            <li><b>2015</b><br>Singapore Youth Festival Arts Presentation - <em>Certificate of Accomplishment</em></li>
                        </ul>
                    </div>
                    <div class="infocard">
