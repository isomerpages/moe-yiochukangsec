...
<div class="yck-component">
    <div class="regular-flow">
        <article>
            ...
            <section>
                ...
                <ul>
                    <li>
                        <b>2025</b><br>C Div Girls NSG League 4, 2<sup>nd</sup> Position
                    </li>
                    <li>
                        <b>2023</b><br>North Zone Badminton Championship ‘C’ Division
                        Girls (Top 8)
                    </li>
                    <li>
                        <b>2022</b><br>North Zone Badminton Championship ‘C’ Division
                        Girls (Top 8)
                    </li>
                    <li>
                        <b>2019</b><br>North Zone Badminton Championship ‘C’ Division
                        Girls (Top 8)
                    </li>
                </ul>
            </section>
   ...
   <style>
    ...
    :root {
        ...
        /* Accent: Algal Fuel */
        --yck-green-100: #f2fffb;
        --yck-green-200: #bcfee6;
        --yck-green-300: #83f8c7;
        --yck-green-400: #4ae79d;
        --yck-green-500: #16c768;
        --yck-green-600: #079f45;
        --yck-green-700: #02772b;
        --yck-green-800: #004e17;
        --yck-green-900: #002609;
        ...
        --yck-color-text-primary: var(--neutral-900);
        --yck-color-text-secondary: var(--neutral-800);
        --yck-color-background: #fff;
        --yck-color-accent: #e37f2a;
        --yck-color-border: var(--yck-orange-300);
        --yck-color-card-bg: var(--yck-orange-200);
        --yck-color-hover: var(--yck-orange-500);
        ...
        --font-antique: Superclarendon, Bookman Old Style, URW Bookman, URW Bookman L, Georgia Pro, Georgia,
            serif;
