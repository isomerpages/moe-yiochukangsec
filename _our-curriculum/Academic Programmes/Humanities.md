...
<div class="yck-component">
    <div class="regular-flow">
        ...
        <details name="keyprog">
            <summary>
                <h4><strong>Geographical Investigation</strong></h4>
            </summary>
        ...
        <details name="keyprog">
            <summary>
                <h4><strong>Issue Investigation</strong></h4>
            </summary>
        ...
        <details name="keyprog">
            <summary>
                <h4><strong>Learning through Play</strong></h4>
            </summary>
        ...
        <div class="deadctr-container">
            <div class="deadctr-content">
                <details>
                    <summary>
                        <h5><strong>HOD Humanities:</strong></h5>
                    </summary>
                    <div>Mdm Chen Huijun [ext 113]</div>
                </details>
            </div>
        </div>
    </div>
...
<div class="yck-component">
    <div class="regular-flow">
        ...
        <figure>
            <img alt="" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/Humanities/H2.png">
        </figure>
        <figure>
            <img alt="" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/Humanities/H3.png">
        </figure>
        <figure>
            <img alt="" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/Humanities/H4.png">
        </figure>
    </div>
</div>
