        ...
        <article id="top">
            ...
            <section id="gallery">
                <div style="--width: 420px; --height: 430px;" class="carousel slider" id="pic_carousel">
                    <div style="--quantity: 8; --duration: 60s;" class="list">
                        <div style="--position: 1" class="item">
                            <div class="carousel card">
                                <figure>
                                    <img alt="NT Special Subjects Photo Gallery" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/NT%20Special%20Subjects/N2.png">
                                    <figcaption>
                                        <p>1<sup>st</sup> runner-up at the National Schools Literature Festival choral speaking competition</p>
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
                        <div style="--position: 2" class="item">
                            <div class="carousel card">
                                <figure>
                                    ...
                                    <figcaption>
                                        <p>English/Effective Reading Programme</p>
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
                        <div style="--position: 3" class="item">
                            <div class="carousel card">
                                <figure>
                                    <img alt="NT Special Subjects Photo Gallery" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/NT%20Special%20Subjects/N6.png">
                                    <figcaption>
                                        <p>A reader's theatre presentation at our inaugural Reading Week assembly programme</p>
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
                        <div style="--position: 4" class="item">
                            <div class="carousel card">
                                <figure>
                                    <img alt="NT Special Subjects Photo Gallery" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/NT%20Special%20Subjects/N7.jpg">
                                    <figcaption>
                                        <p>Showing appreciation to the reading mentors for a year-long journey</p>
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
                        <div style="--position: 5" class="item">
                            <div class="carousel card">
                                <figure>
                                    <img alt="NT Special Subjects Photo Gallery" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/NT%20Special%20Subjects/N8.png">
                                    <figcaption>
                                        <p>Reading Mentors</p>
                                    </figcaption>
                                </figure>
                        ...
                        <div style="--position: 7" class="item">
                            <div class="carousel card">
                                <figure>
                                    <img alt="NT Special Subjects Photo Gallery" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/NT%20Special%20Subjects/N5.png">
                                    <figcaption>
                                        <p>This is fun!</p>
                                    </figcaption>
                                </figure>
                        ...
                        <div style="--position: 8" class="item">
                            <div class="carousel card">
                                <figure>
                                    <img alt="NT Special Subjects Photo Gallery" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/Academic%20Programmes/NT%20Special%20Subjects/N4.png">
                                    <figcaption>
                                        <p>This is fun!</p>
                                    </figcaption>
                                </figure>
...
font-size: calc(var(--yck-step-)*.85);
font-weight: 300;
color: #ffffff;
text-transform: uppercase;
...
font-size: calc(var(--yck-step-3)*1);
font-weight: 700;
color: #555;
text-transform: capitalize;
text-shadow: 2px 2px 3px rgba(206, 60, 60, .5), 3px 3px 4px rgba(0, 0, 0, 0.35);
}
.yck-component .contact-card:hover .dept {
background: transparent;
}
/* Line 2 styles */
...
.yck-component .contact-card:focus-visible::before {
opacity: 1;
}
