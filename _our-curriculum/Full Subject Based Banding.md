...
description: "YCKSS adopts Full Subject-Based Banding: flexible subject levels,
  inclusive classroom environments, and new pathways for Secondary 1 and 2
  students from 2023 onwards."
variant: markdown
        ...
        <article>
            <section id="custom-fsbb">
                <div class="section-header">
                    ...
                    <div class="intro-box">
                        Yio Chu Kang Secondary School is one of the 30+ secondary schools which will implement
                        Full Subject-Based Banding (Full SBB) from 2023.
                    </div>
                    <img alt="Girl mascot" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/f1girl.png" class="mascot-girl">
                </div>
                <div class="purpose-body">
                    <img alt="Boy mascot" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Curriculum/f1boy.png" class="mascot-boy">
                    <div class="purpose-box">
                        <h2 class="purpose-title">Purpose of FSBB</h2>
                        <p>
                            Full SBB is part of MOE's ongoing efforts to nurture the joy of learning and develop multiple pathways to cater to the different strengths and interests of our students.
                        </p>
                        <p>
                            With Full SBB, we are moving towards one secondary education, with many subject bands, to better meet our students' needs. This is part of the broader shift in our education system to recognize the strengths and interests of our children, to help them build their confidence and develop an intrinsic motivation to learn for life. We also hope that our students embrace inclusiveness and thrive in diversity.
                        </p>
                    </div>
                </div>
            </section>
            <section>
                ...
                <table class="rwd-table">
                    ...
                    <tbody>
                        <tr>
                            <td data-th="ASPECT OF FULL SBB:">
                                <p style="margin-top: 1em">Mixed form classes with the provision of a common curriculum</p>
                            </td>
                            <td data-th="HOW WILL THIS ASPECT BE IMPLEMENTED?">
                                <p style="margin-top: 1em">Our school will implement mixed form classes starting from <strong>Secondary 1.</strong></p>
                                ...
                                <ul>
                                    <li>Art</li>
                                    <li><a class="text-link" href="/our-curriculum/Non-Academic-Programmes/Character-and-Citizenship-Education/">Character and Citizenship Education</a></li>
                                    <li><a class="text-link" href="/our-curriculum/academic-programmes/design-and-enterprise/">Design and Technology</a></li>
                                    <li>Food and Consumer Education</li>
                                    <li>Music</li>
                                    <li><a class="text-link" href="/our-curriculum/Academic-Programmes/Physical-Education/">Physical Education</a></li>
                                </ul>
                                <p></p>
                                ...
                                <p>English Language, Mother Tongue Languages, Mathematics, and Science will continue to be offered at Express Level, N(A) Level, and N(T) Level.</p>
                                <p>The criteria for taking these subjects at a more demanding level from the start of Secondary One is based on students’ PSLE AL Score for each subject. Students will be grouped in different classes based on their subject level for each subject.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <section id="moreinfo">
                <div class="info-container">
                    <div class="infocard">
                        <p>
                            For more information on FSBB, please visit <a class="text-link" target="_blank" href="https://www.moe.gov.sg/microsites/psle-fsbb">www.moe.gov.sg/microsites/psle-fsbb</a>.
                        </p>
                    </div>
                    <div class="infocard">
                        <p>
...
.yck-component td :is(p, li), .yck-component .yck-td :is(p, li) {
line-height: 1.4;
text-wrap: pretty;
word-wrap: break-word;
}
.yck-component td :is(p, ul, ol), .yck-component .yck-td :is(p, ul, ol) {
