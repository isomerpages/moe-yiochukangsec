...
<section>
   <table class="yck-table">
        ...
        <tbody>
            <tr>
                <td class="yck-td"><p>Mixed form classes with the provision of a common curriculum</p></td>
                <td class="yck-td">
