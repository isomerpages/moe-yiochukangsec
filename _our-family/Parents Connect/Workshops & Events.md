...
permalink: /our-family/parents-connect/workshops-events/
variant: markdown
description: ""
...
<div class="yck-component">
	<div class="regular-flow">
		<article>
			<section>
	<h2>Stay Tuned for upcoming events in Semester 1 of 2026.</h2>
	<p>Or ... You may visit our <a class="text-link" target="_blank" href="https://www.facebook.com/yiochukangsec">YCKSS Facebook&nbsp;</a> or&nbsp;<a class="text-link" target="_blank" href="https://www.instagram.com/yiochukang_sec/">Instagram</a> for some updates.</p>
			</section>
			<section>
				<div class="yck-cards">
					<div class="yck-card">
						<figure>
					<img src="/images/Our%20Story/YCKSS_FacebookQRCode.png"><figcaption><a class="text-link" target="_blank" href="https://www.facebook.com/yiochukangsec">YCKSS Facebook</a></figcaption></figure>
		</div>
					<div class="yck-card">
						<figure>
			<img src="/images/Our%20Story/YCKSS_InstagramQRCode.png"><figcaption><a class="text-link" target="_blank" href="https://www.instagram.com/yiochukang_sec/">YCKSS Instagram</a></figcaption></figure>
</div>
				</div>
			</section>
		</article>
...
:root {
    ...
    --yck-inset-shadow1: rgba(50, 50, 93, .25) 0 30px 60px -12px inset, rgba(0, 0, 0, .3) 0 18px 36px -18px inset;
