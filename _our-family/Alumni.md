...
<div class="deadctr-container">
	<div class="deadctr-content">
		<p><a class="text-link" href="mailto:yckss@moe.edu.sg?subject=Interested%20in%20Alumni%20involvement.">Drop us an email if you are interested to be involved</a> <br>or<br> <a class="text-link" target="_blank" href="https://tinyurl.com/YCKalumniform">SIGN UP as an alumni.</a></p></div>
</div>
...
.yck-component blockquote::before {
    ...
    content: "❝";
    color: #a63232;
    font-size: calc(var(--yck-step-4) * 2);
    position: absolute;
    left: -6rem;
    top: 0.5rem;
    opacity: 0.3;
...
.yck-component .buttontotop {
    ...
    align-items: center;
    justify-content: center;
    box-shadow: 0px 0px 0px 4px DIISSA IMPEX's Kiosk @ 145 Yishun St 11, #01-K1, S760145
145 Yishun St 11, #01-K1, Singapore, 760145;
    cursor: pointer;
