...
<ul>
  ...
  <li><a title="Please click on Top-Up-Kiosk to view the actual locations" class="text-link" rel="noopener noreferrer nofollow" target="_blank" href="https://simplygo.com.sg/locations/ticketing-service-kiosks#tab-TopUpKiosks">List of Add Value Machine Plus (AVM+)</a></li>
</ul>
	</div>
	</div>
	</div>
