...
.yck-component .isomer-card:has(img) {
    ...
    background-color: #fff; /* Or any dark color you prefer */
    transition: filter 0.5s ease;
}

/* Optional: You can also adjust the hover state for image cards */
.yck-component .isomer-card:has(img):hover {
    filter: brightness(90%);
    background-color: #898989; /* A slightly lighter dark on hover */
}
