    ...
    <div class="regular-flow">
        <article>
            <section id="profdev">
                ...
                <div class="columns">
                    <div class="quote">
                        <div class="blockquote">"I learnt how to make use of lCT to gather feedback on student learning."<cite>Annonymous ...</cite>
                        </div>
                    </div>
                    <div class="quote">
                        <div class="blockquote">"I will make an effort to cater to the different learning needs of the students by incorporating some of the DI strategies."<cite>Annonymous ...</cite>
                        </div>
                    </div>
                </div>
                <figure>
            ...
            <section>
                <details open="" name="intellectual" id="celeblearningday">
                    <summary>Celebration of Learning Day</summary>
                    <div class="content">
                ...
                <details name="intellectual" id="firstaid">
                    <summary>First Aid Course</summary>
                    <div class="content">
