...
<div class="yck-component" id="top">
    <div class="regular-flow">
        <article>
            <section id="fruitsgalore">
                <h3>Fruit Galore: For durian lovers or not?</h3>
                <p>On 7 January, the school canteen was morphed into a fruit paradise where colleagues gathered to catch up after the year-end holidays over Fruit Galore!</p>
                <p>The star of the show was none other than the king of fruits: durian! Its distinctive aroma wafted through the canteen, attracting durian devotees to brave the robust scent just to be rewarded with the rich, creamy goodness inside. Those who scrunched up their noses flocked to the delightful spread of other fruits. Amid bites of sweet, juicy fruits and playful jokes about who could handle the durian ‘power’, the staff reconnected, laughed, and shared stories from the holidays.</p>
                ...
                <p>This gathering of fruity chaos was a perfect reminder: Sometimes, the best moments are casual, fruity, and shared with good company.</p>
            </section>
            <hr>
            <section>
                <details name="social">
                    <summary id="kiwis">Black Gold or Golden Kiwis?
                    </summary>
                    <div class="deadctr-container">
                        <div class="quote">
                            <div class="blockquote">"Your Choice. Your Delight!"<cite>Annonymous</cite>
                            </div>
                        </div>
                    </div>
                    <div class="content">
                        <p>Every year, fruit lovers are faced with an irresistible dilemma: a life choice that stirs the taste buds.</p>
                        <div style="--width: 480px; --height: 360px; --quantity: 3; --duration: 10s;" class="carousel slider">
                            <div class="carousel list">
                                <div style="--position: 1" class="carousel item">
                                    <div class="carousel card">
                                        <figure>
                                ...
                                <div style="--position: 2" class="carousel item">
                                    <div class="carousel card">
                                        <figure>
                                            <img alt="Staff activity image 1" src="https://staging-lite.d3o5f2eggdqz6.amplifyapp.com/images/Our%20Family/Staff/SWC%20Activities/Social/2025_durians_kiwi01b.jpg">
                                        </figure>
                                    </div>
                                </div>
                                <div style="--position: 3" class="carousel item">
                        ...
                        <p>On 30 July 2025, a much-welcomed message was dropped, hinting at the arrival of two seasonal treasures. The air grew thick with anticipation, and the mood quickly shifted into high gear.</p>
                        <p>Some made a beeline for the Heritage Gallery with like-minded colleagues, eager to savour the king of fruits—the rich, creamy Black Gold. Others scrunched up their noses at its potent aroma and cheerfully quipped, “Enjoy the king of fruits,” before turning to claim a crown jewel—the tangy-sweet <a class="text-link" target="_blank" href="https://en.wikipedia.org/wiki/Zespri">Zespri</a> golden kiwi.</p>
                        <p>The liberty of choice has transformed the school into a stage for this cherished ritual of flavour and friendly rivalry.</p>
                    </div>
                </details>
                <details name="social">
                    <summary id="sad2024">
                    ...
                    <div class="content">
                        ...
                        <p>As the delectable eight-course feast unfolded, the room buzzed with excitement, spurred on by a battery of games. Fearless and fun-loving souls dressed up as Albert Einstein, Ninja Turtle, Phua Chu Kang, Wonder Woman or Pikachu with whatever their tablemates could find.</p>
                        <p>The invitees also uncovered each other's hidden talents and passions: Who blesses people with self-made pineapple tarts? Who is an intrepid traveler and converses in Japanese effortlessly? Whose home is a kitty paradise?</p>
                        <p>Whether or not you know these answers, the YCKSS family was awestruck by the versatility and delightful surprises of those in the very same room. Even the conventional lucky draw had an uncannily unconventional twist, leaving everyone beaming as winners of vouchers, big wads or not.</p>
                        <div style="--width: 480px;  --height: 360px;  --quantity: ; --duration: 15s;" class="carousel glider">
                            <div class="carousel list">
                                <div style="--position: 1" class="carousel item">
                                    <div class="carousel card">
                                        <figure>
                ...
                <details name="social">
                    <summary id="minidurians2024">Mini Durian Delights
                    </summary>
                    <div class="content">
                ...
                <details name="social">
                    <summary id="hariraya2024">Embracing the Spirit of Hari Raya
                    </summary>
                    <div class="content">
                ...
                <details name="social">
                    <summary id="cny2024">Chinese New Year Celebrations 2024
                    </summary>
                    <div class="content">
