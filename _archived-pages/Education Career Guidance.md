...
<section class="yck-component">
    <div class="regular-flow">
        <h2>Education Career Guidance (ECG)</h2>
        <p>
        ...
        <h3>1. ECG Curriculum</h3>
        <h4>Structured ECG Lessons</h4>
        <p>
        ...
        <p>
            This is an online portal that facilitates education and career
        ...
        <p>
            ...
            with our ECG Counsellor. Mr Isaac also conducts in house workshops for
