                                        ...
                                        <div class="regular-flow">
                                            ...
                                            <details id="top">
                                                ...
                                                <div>
                                                    ...
                                                    <p>For Lower Secondary D&amp;T and FCE which are conducted in alternate semesters, the <abbr title="School-Based Assessment">SBA</abbr> structure &amp; weighting distribution are as follows:</p>
                                                    <table class="yck-table">
                                                        <thead>
                                                            <tr>
                                                                <th class="yck-th"></th>
...
@media (max-width: 640px) {
    ...
    #note1 {
        ...
        text-align: left;
        border-radius: var(--yck-spacing-unit);
        width: fit-content;
        transition: all 1s ease;
    }

    #note1:hover {
        background: rgba(245, 209, 105, 0.5);
    }
    ...
    .yck-component section h3 {
        /* border-bottom: 2px solid #3b82f6;
            color: #1d4ed8; */
    }

    .yck-component section ol,
    .yck-component section ul {
        margin: 0;
        padding-left: var(--yck-spacing-unit);
        line-height: 1.6;
        margin-bottom: 1.5rem;
    }

    .yck-component section ol li {
        margin: 0;
        padding: 0;
        margin-bottom: 1rem;
    }

    .yck-component section ol li ul {
        margin-top: 0.25rem;
        line-height: 1.5;
    }

    .yck-component section ol li ul li {
        margin: 0;
        padding: 0;
    }

    .yck-component .warning-section {
    ...
    .yck-component .warning-section h4 {
        color: #b91c1c;
        border-bottom: none;
    }

    .yck-component .warning-section p,
    .yck-component .warning-section ol {
        color: #374151;
    }

    .yck-component footer {
        text-align: center;
