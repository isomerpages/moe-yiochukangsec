...
<div id="yck-component">
    <div class="masthead" id="ntss">
        <h2>Normal Technical Special Subjects</h2>
    </div>
</div>
    ...
    <div class="columns3">
        ...
        <details name="keyprog">
            ...
            <div>
                ...
                <p>The learning journeys are also aligned to the CCE outcomes, especially in the area of Education and Career Guidance (ECG) for our Secondary three and four students.</p>
...
.masthead {
    ...
    #ntss {
        background: radial-gradient(ellipse at center, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 37%, rgba(0, 0, 0, 0.65) 100%), url(https://placehold.co/1280x720?text=NTSS) no-repeat center center scroll;
    }
